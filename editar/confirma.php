   ...
   //   error_reporting(E_ALL); 
		...
		if (!$rou) 
		{
			echo '<meta http-equiv="Refresh" content="7;URL=../index.html" />' ;          
 				die("NO SE HA ENCONTRADO LA RESERVA SOLICITADA");
			exit();
		}
		if ($rou["estat"]==7) 
		{
			echo '<meta http-equiv="Refresh" content="10;URL=../index.html" />' ;          
			die("ESTA RESERVA YA CONSTA COMO PAGADA CON TARJETA DE CREDITO. <b>NO NECESITA CONFIRMAR EL PAGO</b>.<br/><br/>SI NO HA RECIBIDO UNA NOTIFICACIÓN DEL RESTAURANTE CONFIRMANDOLE LA RECEPCIÓN DEL PAGO CONTACTE CON NOSOTROS");
			exit();	
		}
		...
		{
			echo '<meta http-equiv="Refresh" content="7;URL=../index.html" />' ;          
			die("LA RESERVA QUE INTENTA VALIDAR COMO PAGADA POR TRANSFERENCIA NO CONSTA COMO CONFIRMADA. PUEDE HABER CADUCADO, O ESTAR PENDIENTE DE CONFIRMACION. <br/><br/>POR FAVOR, CONTACTE CON EL RESTAURANTE");
			exit();
		}
