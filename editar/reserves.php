...
if (isset($_POST['nocalsots']) && $_POST['nocalsots']>0) $_POST['observacions']="<b>Sol·licitades ".$_POST['nocalsots']." substitucions de menú calçotada per menú nº1</b><br/><br/>".$_POST['observacions'];
if (!isset($_POST['factura'])) $_POST['factura'][0]=0;
$query = sprintf("INSERT INTO reserves (id_reserva, `data`, client_id, nom, tel, fax, email, hora, menu, adults, nens10_14, nens4_9, cotxets, observacions, resposta, estat, data_creacio, preu_reserva, lang, txt_1, txt_2, num_1, num_2,factura,factura_cif,factura_nom,factura_adresa,reserva_navegador,reserva_info) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['client_nom']." ".$_POST['client_cognoms'], "text"),
                       ...
                       GetSQLValueString($resp[$lang], "text"),
                       GetSQLValueString($estat, "int"),
                       GetSQLValueString($_POST['data_creacio'], "date"),
                       GetSQLValueString($preu, "double"),
                       GetSQLValueString($lang, "text"),
                       GetSQLValueString($_POST['txt_1'], "text"),
                       GetSQLValueString($_POST['txt_2'], "text"),
                       GetSQLValueString($_POST['num_1'], "int"),
                       GetSQLValueString($_POST['num_2'], "int"),
                       $_POST['factura'][0]?1:0,
                       GetSQLValueString($_POST['factura_cif'], "text"),
                       GetSQLValueString($_POST['factura_nom'], "text"),
                       GetSQLValueString($_POST['factura_adresa'], "text"),
                       GetSQLValueString($_POST['reserva_navegador'], "text"),
