...
&nbsp;<BR>
		<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="154" BORDER="0">
			...
			<TR>
				<TD CLASS="transparent"><A HREF="#3">Men&uacute; nº1 Celebraci&oacute;</A></TD>
			</TR>
			<TR>
				<TD>&nbsp;</TD>
			</TR>
			...
			<TR>
				<TD CLASS="transparent"><A HREF="#5">Men&uacute; nº2 Celebraci&oacute;</A></TD>
			</TR>
			<TR>
				<TD>&nbsp;</TD>
			</TR>
			...
			<TR>
				<TD CLASS="transparent"><A HREF="#8">Men&uacute; Comuni&oacute;</A></TD>
			</TR>
			<TR>
				<TD>&nbsp;</TD>
			</TR>
...
<IMG SRC="../img/pix.gif" WIDTH="1" HEIGHT="3" BORDER="0"></TD>
			...
			<TR>
				<TD CLASS="transparent"><IMG SRC="../img/pix.gif" WIDTH="1" HEIGHT="2" BORDER="0"><BR>
<A HREF="suggeriments.php">Suggeriments i informaci&oacute; general</A><BR>
<IMG SRC="../img/pix.gif" WIDTH="1" HEIGHT="3" BORDER="0"></TD>
			</TR>
		</TABLE>
		</TD>
...
Amanida verda<BR>
Escalivada<BR>
Esp&agrave;rrecs bladers a la brasa<BR>
Esp&agrave;rrecs blancs<BR>
G&iacute;rgoles a la brasa<BR>
Cal&ccedil;ots (temporada)<BR>
Carxofes a la brasa (temporada)<BR>
Esqueixada<BR>
Entrem&egrave;s<BR>
Cargols de la casa<BR>
Assortit de pat&eacute;s<BR>
Anxoves de l'Escala<BR>
Mel&oacute; o Pinya amb pernil<BR>
Cabdells amb tonyina i anxoves<BR>
Cargols a la llauna<BR>
&nbsp;<BR>
</UL>
<B>CARNS</B>
<UL>
Xai a la brasa (3 peces)<BR>
Costella de xai a la brasa (unitat)<BR>
Espatlla de xai a la brasa<BR>
Conill a la brasa (1/2 pe&ccedil;a)<BR>
Botifarra a la brasa<BR>
Botifarra negra a la brasa<BR>
Pollastre a la brasa (1/2 pe&ccedil;a)<BR>
Costella de vedella a la brasa<BR>
Mand&iacute;bula de porc a la brasa (unitat)<BR>
Vedella amb bolets<BR>
Peus de porc a la brasa (3 mitjons)<BR>
Llom a la brasa<BR>
&nbsp;<BR>
</UL>
<B>PEIX</B>
<UL>
Moixarra a la brasa<BR>
Llobarro a la brasa<BR>
&nbsp;<BR>
</UL>
<B>COMPLEMENTS</B>
<UL>
Mongetes del Ganxet<BR>
...
<B>PREU</B>
<UL>
El nostre preu mig aproximat &eacute;s de: <?php echo PREU_MIG ?> Euros (IVA incl&ograve;s)
</UL>
 <BR>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2001); ?> Euros/unitat adults (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2002); ?> Euros/unitat adults amb cava (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Infantil</B> (nens de 4 a 9 anys)<BR>
Macarrons, pollastre arrebossat o croquetes amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2037); ?> Euros/unitat (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Junior</B> (de 10 a 14 anys)<BR>
Macarrons o entrem&egrave;s, pollastre o botifarra amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2036); ?> Euros/unitat (IVA incl&ograve;s)
</UL>
 <BR>
...
<!---------------------------------------------------------------------------------->
<A NAME="3">&nbsp;</A><BR>
<FONT CLASS="titol"><B>MEN&Uacute; Nº 1 CELEBRACI&Oacute;</B></FONT>
<HR SIZE="1">
&nbsp;<BR>
<B>ENTRANTS</B>
<UL>
...
<B>POSTRES</B>
<UL>
Past&iacute;s de crema-cremada<BR>
Past&iacute;s de nata i trufa<BR>
Past&iacute;s massini<BR>
Past&iacute;s de llimona<BR>
&nbsp;<BR>
</UL>
<B>CAF&Egrave;S, TALLATS o CIGALONS</B><BR>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2024); ?> Euros/unitat adults sense cava (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2025); ?> Euros/unitat adults amb cava (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Infantil</B> (nens de 4 a 9 anys)<BR>
Macarrons, pollastre arrebossat o croquetes amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2037); ?> Euros/unitat (IVA incl&ograve;s)<BR>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2003); ?> Euros/unitat adults sense cava (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2004); ?> Euros/unitat adults amb cava (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Infantil</B> (nens de 4 a 9 anys)<BR>
Macarrons, pollastre arrebossat o croquetes amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2037); ?> Euros/unitat (IVA incl&ograve;s)<BR>
...
<!---------------------------------------------------------------------------------->
<A NAME="5">&nbsp;</A><BR>
<FONT CLASS="titol"><B>MEN&Uacute; Nº 2 CELEBRACI&Oacute;</B></FONT>
<HR SIZE="1">
&nbsp;<BR>
<B>ENTRANTS</B>
<UL>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2023); ?> Euros/unitat adults sense cava (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2027); ?> Euros/unitat adults amb cava (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Infantil</B> (nens de 4 a 9 anys)<BR>
Macarrons, pollastre arrebossat o croquetes amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2037); ?> Euros/unitat (IVA incl&ograve;s)<BR>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2012); ?> Euros (IVA incl&ograve;s)</UL>
 <BR>
...
<A HREF="#0"><IMG SRC="../img/bt_amunt.gif" WIDTH="15" HEIGHT="15" BORDER="0" ALT="Amunt"></A><BR>
<A NAME="10">&nbsp;</A><BR>
<FONT CLASS="titol"><B><br>
MEN&Uacute; N&ordm; 4 </B></FONT>
<HR SIZE="1">
&nbsp;<BR>
<B>ENTRANTS</B>
<UL>
...
<UL>
  <?php echo $carta->preuPlat(2007); ?>
   Euros
   <!--/unitat adults sense cava --> (IVA incl&ograve;s)<BR>
</UL>
 
<p><BR>
  <IMG SRC="../img/pix.gif" WIDTH="69" HEIGHT="1" BORDER="0"><A HREF="javascript:openFoto('../img/f_plats_11.html','_blank',450,315)"><IMG SRC="../img/f_plats_11pt.jpg" WIDTH="80" HEIGHT="80" BORDER="0" ALT="Foto" TITLE="Ampliar"></A>&nbsp;<A HREF="javascript:openFoto('../img/f_plats_5.html','_blank',450,300)"><IMG SRC="../img/f_plats_5pt.jpg" WIDTH="80" HEIGHT="80" BORDER="0" ALT="Foto" TITLE="Ampliar"></A>&nbsp; <BR>
  <!---------------------------------------------------------------------------------->
  <!---------------------------------------------------------------------------------->
  <br><A HREF="#0"><IMG SRC="../img/bt_amunt.gif" WIDTH="15" HEIGHT="15" BORDER="0" ALT="Amunt"></A><br>
  <BR>
  <A NAME="7">&nbsp;</A><BR>
  <FONT CLASS="titol"><B>MEN&Uacute; CAL&Ccedil;OTADA</B></FONT></p>
 <HR SIZE="1">
&nbsp;<BR>
<B>ENTRANTS</B>
<UL>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2010); ?> Euros (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Men&uacute; Infantil</B> (nens de 4 a 9 anys)<BR>
Macarrons, pollastre arrebossat o croquetes amb patates, refresc i gelat<BR>
<?php echo $carta->preuPlat(2037); ?> Euros/unitat (IVA incl&ograve;s)<BR>
...
<!---------------------------------------------------------------------------------->
<A NAME="8">&nbsp;</A><BR>
<FONT CLASS="titol"><B>MEN&Uacute; COMUNI&Oacute;</B></FONT>
<HR SIZE="1">
&nbsp;<BR>
<B>VERMUT</B>
<P>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2013); ?> Euros (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Nens:</B><BR>
<?php echo $carta->preuPlat(2017); ?> Euros nens de 4 a 9 anys (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2018); ?> Euros nens de 10 a 14 anys (IVA incl&ograve;s)
</UL>
...
<!---------------------------------------------------------------------------------->
<A NAME="9">&nbsp;</A><BR>
<FONT CLASS="titol"><B>MEN&Uacute; CASAMENTS</B></FONT>
<HR SIZE="1">
&nbsp;<BR>
<B>APERITU</B>
<UL>
...
<B>PREU</B>
<UL>
<?php echo $carta->preuPlat(2016); ?> Euros (IVA incl&ograve;s)<BR>
&nbsp;<BR>
<B>Nens:</B><BR>
<?php echo $carta->preuPlat(2021); ?> Euros nens de 4 a 9 anys (IVA incl&ograve;s)<BR>
<?php echo $carta->preuPlat(2022); ?> Euros nens de 10 a 14 anys (IVA incl&ograve;s)
</UL>
