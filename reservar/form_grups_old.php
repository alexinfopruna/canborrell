...
&lArr;
			...
			<div>
				...
				<div class="caixa dere ui-corner-all" style="float:right;"><?php l('INFO_QUANTS_SOU_GRUPS');?>
					 <input type="text" name="totalComensals" value="0" readonly="readonly" class="coberts"/></b>
		...
		<div class="fr-seccio ui-corner-all fr-seccio-carta"> 
				<h1 class="titol"><span class="number">4</span><?php l('Escull el menú');?></h1>
					<!-- ******  COMANDA  ********   -->
				<div class="ui-corner-all info">
					<?php l('INFO_CARTA_GRUPS');?>
				</div>
				<div style="clear:both"></div>
				<table>
				<tr>
				<td><input type="text" id="input_menu_adults" name="menu_adults" value=""  /></td>
				<td><input type="text" id="input_menu_juniors" name="menu_juniors" value="sense nens"  /></td>
				<td><input type="text" id="input_menu_nens" name="menu_nens" value="sense juniors"  /></td>
				</tr>
				</table>
					...
					<!-- ******  MENUS ADULTS  ********   -->
				<div id="carta" class="col_dere">
					<div class="caixa dere ui-corner-all llista-menus menu-adults">
						<?php include("menus_adults.php");?>
					</div>
				</div>
					<!-- ******  MENUS JUNIORS  ********   -->
				<div id="carta2" class="col_dere">
					<div class="caixa dere ui-corner-all llista-menus menu-juniors" style="display:none">
						<?php include("menus_juniors.php");?>
					</div>
				</div>
					<!-- ******  MENUS NENS  ********   -->
				<div id="carta3" class="col_dere">
					<div class="caixa dere ui-corner-all llista-menus menu-nens" style="display:none">
						<?php include("menus_nens.php");?>
					</div>
				</div>
					<!-- ******  INFO  ********   -->
...
<!-- ******************* CARTA *********************** -->
<!-- ******************* CARTA *********************** -->
<div id="fr-carta-popup" title="La nostra carta">
<div id="fr-carta-tabs" class="ui-helper-hidden">
	<?php //echo $gestor->recuperaCarta()?>
</div>	
</div>	
