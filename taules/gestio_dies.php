...
$fitxer=INC_FILE_PATH."llista_dies_negra.txt";
...
if (strstr($fitxer,"online")) 
	echo '
	<h4>ELS DIES BLOQUEJATS AFECTEN NOMÉS AL FORMULARI DE RESERVES PETITES</h4>
';
else
	echo '
	<h4>ELS DIES BLOQUEJATS AFECTEN NOMÉS AL CONTROL TAULES</h4>
	<h4>ELS DIES DESBLOQUEJATS HAN DE SER DILLUNS o DIMARTS. AFECTEN A TOT ARREU (control_taules, form_petites, form_grups)</h4>
...
<form name="form1" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
  ...
  <tr>
    <td>	
      <a href="taules.php">Torna a la gestió de taules</a></td>
     <td>&nbsp;</td>
    <td>&nbsp;</td>
   </tr>
 <tr>
 ...
 <tr>
    <td>	<p>&nbsp;</p>
      <p>
		...
		<?php if ($showBlancs):?>
			<iframe width="100%" height="300px" src="gestio_dies_blancs.php" style="border:0"></iframe>
		<?php endif; ?>
	</p></td>
    </tr>
