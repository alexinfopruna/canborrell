...
<style type="text/css">
<!--
.special { background-color: #0C0; color: #fff; }
...
<BODY>
<CENTER>
<form name="form1" method="post" action="gestio_dies_blancs.php?f=llista_dies_blanca.txt">
  <table width="773" border="0" cellpadding="0" cellspacing="0" bgcolor="#F8F8F0">
  <tr>
    <td width="262">&nbsp;</td>
    <td width="200" align="center"><strong>MARCA AQUÍ SI UN DILLUNS O DIMARTS OBRIU</strong> </td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td>&nbsp;</td>
...
{
     //if (date.getDay() == 1 || date.getDay() == 2  || date.getDay() == 2  || date.getDay() == 2  || date.getDay() == 2  ) return true;
	return false; 
...
<table width="773" border="0" cellpadding="0" cellspacing="0" bgcolor="#F8F8F0">
  ...
  <tr>
    <td>
	  <div align="center">
	    <input  id="bloq" type="submit" name="bloq" value="Desbloquejar">
	    <input id="desbloq" type="submit" name="dbloq" value="Bloquejar">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  </div></td>
    </tr>
  <tr>
