	<table align="center">
	  ...
	  <tr valign="baseline">
		...
		<button  style="font-size:0.8em;font-weight:normal;padding:3px;" tabindex="-1" type="button" class="sense-numero ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" role="button" aria-disabled="false">Sense número</button>			
