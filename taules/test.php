...
//echo "ENVIEM..... ".$g->enviaMail('32991');

echo "ENVIEM..... ";
        
        echo mailer("alexinfopruna@gmail.com","Asunto","bodyyy","altbody")?" ANAT BE ":" MAL! ";


echo "ENVIEM..... ";
        //echo mail("alexinfopruna@gmail.com","Asunto","bodyyy")?" ANAT BE ":" MAL! ";
...
$mail->SetFrom('alexinfopruna@gmail.com', 'Mi nombre');
//Esta línea es por si queréis enviar copia a alguien (dirección y, opcionalmente, nombre)
$mail->AddReplyTo('replyto@correoquesea.com','El de la réplica');
//Y, ahora sí, definimos el destinatario (dirección y, opcionalmente, nombre)
$mail->AddAddress('alex@infopruna.net', 'El Destinatario');
...
//Enviamos el correo  
  ...
  while ((!$exito) && ($intentos < 1)) {
   ...
   if(!$exito)
   {
      print("<span style='color:red'>MAILER ERROR:</span> Enviat mail TO:$addr $cco SUBJECT: $subject");
      return false;
   }
   else
   {
      print("<span style='color:green'>MAILER SUCCESS:</span>: Enviat mail TO:$addr $cco SUBJECT: $subject");
     return true;
   } 
}
