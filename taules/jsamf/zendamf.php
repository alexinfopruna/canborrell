...
$gateway_url = 'http://cb.localhost/taules/amfphp/gateway.php';
...
try {
    $sabreamf_result = $sabreamf->sendRequest('ControlTaules.recuperaUsuari',new SabreAMF_AMF3_Wrapper(array($parameter)));
